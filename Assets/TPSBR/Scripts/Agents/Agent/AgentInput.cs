...
namespace TPSBR
{
	...
	public sealed partial class AgentInput : ContextBehaviour, IBeforeTick, IAfterAllTicks
	{
		...
		private EGameplayInputActionStates _actionStates = (EGameplayInputActionStates)32767;
		public void SetActionStates(EGameplayInputActionStates states) => _actionStates = states;
		public EGameplayInputActionStates GetActionStates() => _actionStates;
