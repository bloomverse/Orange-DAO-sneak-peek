namespace TPSBR.UI
{
	...
	public class UIScoreboardMini : UIWidget
	{
		// PRIVATE MEMBERS

		[SerializeField]
		private UIScoreboardItemMini _item;
		[SerializeField]
		...
		private ElementCache<UIScoreboardItemMini>           _items;
		...
		protected override void OnInitialize()
		{
			...
			_items = new ElementCache<UIScoreboardItemMini>(_item, 16);
		}
