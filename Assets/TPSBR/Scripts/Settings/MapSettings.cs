...
namespace TPSBR
{
	...
	public sealed class MapSettings : ScriptableObject
	{
		...
		public MapSetup GetMapByScenePath(string mapPath)
		{
			if (mapPath.HasValue() == false)
				return null;

			return _maps.Find(t => t.ScenePath == mapPath);
		}
	...
	public sealed class MapSetup
	{
		...
		public bool Addressable    		  => _adressable;
