...
namespace TPSBR
{
	...
	public class MovingPlatform : ContextTRSPBehaviour, IPlatform, IAfterClientPredictionReset, IBeforeAllTicks, IKCCProcessor, IKCCProcessorProvider
	{
		// PROTECTED MEMBERS

	
        public Vector3 _moveDirection = Vector3.up;
