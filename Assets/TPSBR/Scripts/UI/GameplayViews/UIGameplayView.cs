...
namespace TPSBR.UI
{
	public class UIGameplayView : UIView
	{
		...
		[SerializeField]
		private UIGamePlayLobby _lobby;
		...
		protected override void OnInitialize()
		{
			...
			_lobby.SetActive(Context.GameplayMode is LobbyGameplayMode);



			if (Context.GameplayMode is LobbyGameplayMode ||
			  Context.GameplayMode is TutorialGameplayMode ||
			  Context.GameplayMode is LobbyTutorialGameplayMode ||
			  Context.GameplayMode is ActivityMode)
			{
