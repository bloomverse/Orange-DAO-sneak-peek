...
namespace TPSBR
{
	public abstract class StaticPickup : NetworkBehaviour, IPickup
	{
		...
		string  IInteraction.LongDescription => InteractionLongDescription;
		...
		protected virtual string InteractionLongDescription => _interactionLongDescription;
