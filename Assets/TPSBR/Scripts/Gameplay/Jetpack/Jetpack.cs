...
namespace TPSBR
{
	...
	public sealed class Jetpack : ContextBehaviour
	{
		...
		[SerializeField] public GameObject RocketParticlesL;
		[SerializeField] public GameObject RocketParticlesR;
		[SerializeField] public TrailRenderer trail1;
		[SerializeField] public TrailRenderer trailSomoke;
...
//			RocketParticlesR.GetComponent<ParticleSystem>().Stop();
//			RocketParticlesL.GetComponent<ParticleSystem>().Stop();
...
/*
		...
		private void Activate_Internal()
		{
			...
			RocketParticlesR.GetComponent<ParticleSystem>().Play();
			RocketParticlesL.GetComponent<ParticleSystem>().Play();
