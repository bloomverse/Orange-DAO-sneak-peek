namespace TPSBR
{
	...
	public struct PlayerStatistics : INetworkStruct
	{
		...
		public int       BloomiesEarned   { get { return BloomiesTot;}  set { BloomiesTot = value;}  } 

		private byte     _flags;
		private int 	BloomiesTot;
	}
	...
	public sealed class Player : PlayerInterestManager, IPlayer, IContextBehaviour
	{
		...
		public bool             SkinReady      { get; private set; }
		...
		public string			AgentID        { get; private set; }  // NOT NETWORKED
		[Networked]
		public string			SelectedSkin   { get; private set; }
		[Networked , Capacity(180)]
		public string			RPMSkin        { get; private set; }
		...
		[Networked ]
		public int			LastBloomieBonus          { get; private set; }
		[Networked]
